...
simulation_core.py
=======================
Simulation module for the Spliceosome binding project.

Workflow
--------
1. Create a Simulation object.
2. Call .run_all_models to run the actual simulation.
3. Inspect results with the visualization module.
